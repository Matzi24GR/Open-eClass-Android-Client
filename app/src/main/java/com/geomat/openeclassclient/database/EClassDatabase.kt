...
@Database(entities = [DatabaseCalendarEvent::class,DatabaseCalendarSyncId::class,DatabaseCourse::class,DatabaseFeedUrl::class,DatabaseUserInfo::class,DatabaseAnnouncement::class], version = 18,  exportSchema = false)
